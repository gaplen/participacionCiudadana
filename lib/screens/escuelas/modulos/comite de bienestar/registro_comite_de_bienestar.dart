...
import 'package:flutterfire_samples/widgets/add_item_form_comite_bienestar.dart';

class RegistroComiteBienestar extends StatefulWidget {
  @override
  State<RegistroComiteBienestar> createState() =>
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            elevation: 0,
            backgroundColor: CustomColors.firebaseNavy,
            title: Text('Registro comite bienestar')),
              ...
              children: [
                SafeArea(
                  child: Padding(
                    ...
                    child: AddItemFormComiteBienestar(
