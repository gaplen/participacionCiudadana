...
import 'package:flutterfire_samples/widgets/add_item_form_comite_ejecucion.dart';

class RegistroComiteEjecucion extends StatefulWidget {
  @override
  State<RegistroComiteEjecucion> createState() =>
      _RegistroComiteEjecucionState();
}

class _RegistroComiteEjecucionState extends State<RegistroComiteEjecucion> {
              ...
              children: [
                SafeArea(
                  child: Padding(
                    ...
                    child: AddItemFormComiteEjecucion(
